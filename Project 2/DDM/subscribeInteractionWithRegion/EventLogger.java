...
public class EventLogger
{
	...
	private void publishAndSubscribe() throws RTIexception
	{
		...
		int testSpace = rtiamb.getRoutingSpaceHandle("TestSpace");
		int dim = rtiamb.getDimensionHandle("TestDimension", testSpace);
		
		Region sRegion = rtiamb.createRegion(testSpace, 1);
		sRegion.setRangeLowerBound(0, dim, 0);
		sRegion.setRangeUpperBound(0, dim, 20);
		
		rtiamb.notifyOfRegionModification(sRegion);
		
		rtiamb.subscribeInteractionClassWithRegion( interactionHandle, sRegion );
	}
	...
	public static void main( String[] args )
	{
		...
		String federateName = "diagnosticsFederate2";
		if( args.length != 0 )
		{
			federateName = args[0];
		}
